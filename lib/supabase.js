...
export async function closeTrade(tradeId, exitPrice, direction, entryPrice) {
  ...
  console.log('[Dashboard] closeTrade:', { tradeId, exitPrice, pnl, status, entryPrice })
  ...
  if (!existingTrade) {
    console.log('[Dashboard] Trade not found:', tradeId)
  ...
  console.log('[Dashboard] Trade closed result:', { data, error })
  return { data, error }
}
