...
export async function closeTrade(tradeId, exitPrice, direction, entryPrice) {
  ...
  console.log('[Dashboard] closeTrade:', { tradeId, exitPrice, pnl, status, entryPrice: parseFloat(entryPrice) })
  
  console.log('[Dashboard] closeTrade:', { tradeId, exitPrice, pnl, status })
  ...
  try {
    ...
    console.log('[Dashboard] Attempting to close trade with:', { exit_price: exitPriceNum, pnl: pnlValue, status })
